...
public static class Data
{
    ...
    public static readonly Dictionary<ApItemId, string> ItemNames = new()
    {
        ...
        { ApItemId.WhiteDoorHotpStart, "White Door HotP 1st Room" },
        { ApItemId.WhiteDoorHotpClaw, "White Door HotP Griffon Claw" },
        ...
        { ApItemId.BlueDoorHotpStart, "Blue Door HotP Above Start" },
        { ApItemId.BlueDoorHotpStatue, "Blue Door HotP Epimetheus" },
        { ApItemId.BlueDoorHotpMaiden, "Blue Door HotP Dead Maiden" },
        ...
        { ApItemId.ElevatorHotp, "HotP Elevator" },
        ...
        { ApItemId.SwitchHotpRock, "Rockfall HotP" },
        { ApItemId.SwitchHotpBelowStart, "Door HotP Below Start" },
        { ApItemId.SwitchHotpLeft2, "Door HotP Left 2" },
        { ApItemId.SwitchHotpLeft1, "Door HotP Left 1" },
        { ApItemId.SwitchHotpLowerShortcut, "Door HotP Lower Shortcut" },
        { ApItemId.SwitchHotpBell, "Blocks HotP Bell" },
        { ApItemId.SwitchHotpGhostBlood, "Door HotP Ghost Blood" },
        { ApItemId.SwitchHotpTeleports, "Door HotP Teleports" },
        { ApItemId.SwitchHotpWormPillar, "Door HotP Worm Pillar" },
        { ApItemId.SwitchHotpToClaw1, "Door HotP To Claw" },
        { ApItemId.SwitchHotpToClaw2, "Blocks HotP To Claw" },
        { ApItemId.SwitchHotpClawAccess, "Blocks HotP Claw Access" },
        { ApItemId.SwitchHotpGhosts, "Door HotP Ghosts" },
        { ApItemId.SwitchHotpLeft3, "Blocks HotP Left" },
        { ApItemId.SwitchHotpAboveOldMan, "Door HotP Above Old Man" },
        { ApItemId.SwitchHotpToAboveOldMan, "Blocks HotP To Above Old Man" },
        { ApItemId.SwitchHotpTpPuzzle, "Door HotP TP Puzzle" },
        { ApItemId.SwitchHotpEyeballShortcut, "Blocks HotP Eyeball Shortcut" },
        { ApItemId.SwitchHotpBellAccess, "Blocks HotP Bell Access Left" },
        { ApItemId.SwitchHotp1stRoom, "Blocks HotP 1st Room" },
        { ApItemId.SwitchHotpLeftBacktrack, "Blocks HotP Left Backtrack" },
        { ApItemId.SwitchHotpSkullPuzzle, "Door HotP Skull Puzzle" },
        ...
        { ApItemId.CrystalHotpRockAccess, "Door HotP Rock" },
        { ApItemId.CrystalHotpBottom, "Door HotP Bottom" },
        { ApItemId.CrystalHotpLower, "Blocks HotP Lower" },
        { ApItemId.CrystalHotpAfterClaw, "Door HotP After Claw" },
        { ApItemId.CrystalHotpMaiden1, "Blocks HotP Maiden" },
        { ApItemId.CrystalHotpMaiden2, "Door HotP Maiden" },
        { ApItemId.CrystalHotpBellAccess, "Blocks HotP Bell Access Right" },
        { ApItemId.CrystalHotpHeart, "Blocks HotP Heart" },
        { ApItemId.CrystalHotpBelowPuzzle, "Blocks HotP Below Puzzle" },
        ...
        { ApItemId.FaceHotpOldMan, "Blocks HotP Old Man" },
    ...
    public static readonly Dictionary<ActorIds, string> VoidPortalsById = new()
    {
        ...
        { (879, 1059), "HotP Lower Void Portal" },
        { (3264, 3194), "HotP Upper Void Portal" },
        { (7056, 7249), "HotP Cathedral Void Portal" },
