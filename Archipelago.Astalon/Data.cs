...
public enum ApLocationId
{
    ...
    HopSwitchGhosts,
    HopSwitchLeft3,
    HopSwitchAboveOldMan,
    HopSwitchToAboveOldMan,
    HopSwitchTpPuzzle,
    HopSwitchEyeballShortcut,
    HopSwitchBellAccess,
    HopSwitch1stRoom,
    HopSwitchLeftBacktrack,
    HopCrystalRockAccess,
    HopCrystalBottom,
    HopCrystalLower,
    HopCrystalAfterClaw,
    HopCrystalMaiden1,
    HopCrystalMaiden2,
    HopCrystalBellAccess,
    HopCrystalHeart,
    HopCrystalBelowPuzzle,
    HopFaceOldMan,
    RoaElevator1,
    RoaElevator2,
    RoaSwitchAscend,
...
public enum ApItemId
{
    ...
    SwitchHopGhosts,
    SwitchHopLeft3,
    SwitchHopAboveOldMan,
    SwitchHopToAboveOldMan,
    SwitchHopTpPuzzle,
    SwitchHopEyeballShortcut,
    SwitchHopBellAccess,
    SwitchHop1stRoom,
    SwitchHopLeftBacktrack,
    SwitchRoaAscend,
    SwitchRoaAfterWorms,
    SwitchRoaRightPath,
    SwitchRoaApexAccess,
    ...
    CrystalMechBk,
    CrystalHopRockAccess,
    CrystalHopBottom,
    CrystalHopLower,
    CrystalHopAfterClaw,
    CrystalHopMaiden1,
    CrystalHopMaiden2,
    CrystalHopBellAccess,
    CrystalHopHeart,
    CrystalHopBelowPuzzle,
    CrystalRoa1stRoom,
...
public static class Data
{
    public static readonly Dictionary<ItemProperties.ItemID, ApLocationId> ItemToApLocationId =
        new()
        {
            ...
            { ItemProperties.ItemID.DeadMaidensRing, ApLocationId.HopMaidenRing },
            { ItemProperties.ItemID.LinusMap, ApLocationId.GtMap },
            { ItemProperties.ItemID.AthenasBell, ApLocationId.HopBell },
            ...
            { ItemProperties.ItemID.BoreasGauntlet, ApLocationId.HopGauntlet },
    ...
    public static readonly Dictionary<int, ApLocationId> HealthMap = new()
    {
        ...
        { 9979, ApLocationId.HopHp1Claw },
        { 6173, ApLocationId.HopHp2Ladder },
        { 9279, ApLocationId.HopHp2Gauntlet },
        { 6436, ApLocationId.HopHp5OldMan },
        { 6740, ApLocationId.HopHp5Maze },
        { 6518, ApLocationId.HopHp5Start },
    ...
    public static readonly Dictionary<int, ApLocationId> WhiteKeyMap = new()
    {
        ...
        { 1193, ApLocationId.HopWhiteKeyLeft },
        { 10136, ApLocationId.HopWhiteKeyGhost },
        { 6171, ApLocationId.HopWhiteKeyOldMan },
        { 6546, ApLocationId.HopWhiteKeyBoss },
    ...
    public static readonly Dictionary<int, ApLocationId> BlueKeyMap = new()
    {
        ...
        { 6752, ApLocationId.HopBlueKeyStatue },
        { 6775, ApLocationId.HopBlueKeyGold },
        { 6483, ApLocationId.HopBlueKeyAmulet },
        { 7090, ApLocationId.HopBlueKeyLadder },
        { 6170, ApLocationId.HopBlueKeyTeleports },
        { 6556, ApLocationId.HopBlueKeyMaze },
    ...
    public static readonly Dictionary<ApItemId, ActorIds> WhiteDoorMap = new()
    {
        ...
        { ApItemId.WhiteDoorHopStart, (820, 6166) },
        { ApItemId.WhiteDoorHopClaw, (3012, 6174) },
        { ApItemId.WhiteDoorHopBoss, (2889, 6545) },
    ...
    public static readonly Dictionary<ApItemId, ActorIds> BlueDoorMap = new()
    {
        ...
        { ApItemId.BlueDoorHopStart, (821, 6165) },
        { ApItemId.BlueDoorHopStatue, (2676, 6344) },
        { ApItemId.BlueDoorHopMaiden, (2890, 6175) },
    ...
    [
        ...
        new()
        {
            ...
            ObjectsToTrigger = [],
            ApItemId = ApItemId.SwitchHopRock,
            ApLocationId = ApLocationId.HopSwitchRock,
        },
        new()
        {
            Id = "20",
            ...
            ObjectsToTrigger = [],
            ApItemId = ApItemId.SwitchHopBelowStart,
            ApLocationId = ApLocationId.HopSwitchBelowStart,
        },
        new()
        {
            Id = "21",
        ...
        new()
        {
            ...
            ObjectsToTrigger = [],
            ApItemId = ApItemId.CrystalHopRockAccess,
            ApLocationId = ApLocationId.HopCrystalRockAccess,
        },
        new()
        {
            Id = "26",
        ...
        new()
        {
            ...
            ObjectsToTrigger = [],
            ApItemId = ApItemId.SwitchHopLeft2,
            ApLocationId = ApLocationId.HopSwitchLeft2,
        },
        new()
        {
            Id = "32",
            ...
            ObjectsToTrigger = [],
            ApItemId = ApItemId.SwitchHopLeft1,
            ApLocationId = ApLocationId.HopSwitchLeft1,
        },
        new()
        {
            Id = "33",
        ...
        new()
        {
            ...
            ObjectsToTrigger = [],
            ApItemId = ApItemId.SwitchHopLowerShortcut,
            ApLocationId = ApLocationId.HopSwitchLowerShortcut,
        },
        new()
        {
            Id = "50",
        ...
        new()
        {
            ...
            ObjectsToTrigger = [],
            ApItemId = ApItemId.CrystalHopBottom,
            ApLocationId = ApLocationId.HopCrystalBottom,
        },
        new()
        {
            Id = "81",
            ...
            ObjectsToDisable = [],
            ObjectsToTrigger = [],
            ApItemId = ApItemId.CrystalHopLower,
            ApLocationId = ApLocationId.HopCrystalLower,
        },
        new()
        {
            Id = "82",
            ...
            ObjectsToDisable = [],
            ObjectsToTrigger = [],
            ApItemId = ApItemId.SwitchHopBell,
            ApLocationId = ApLocationId.HopSwitchBell,
        },
        new()
        {
            Id = "83",
            ...
            ObjectsToTrigger = [],
            ApItemId = ApItemId.SwitchHopSkullPuzzle,
            ApLocationId = ApLocationId.HopSkullPuzzle,
        },
        new()
        {
            Id = "84",
            ...
            ObjectsToTrigger = [],
            ApItemId = ApItemId.SwitchHopGhostBlood,
            ApLocationId = ApLocationId.HopSwitchGhostBlood,
        },
        new()
        {
            Id = "88",
            ...
            ObjectsToTrigger = [],
            ApItemId = ApItemId.SwitchHopTeleports,
            ApLocationId = ApLocationId.HopSwitchTeleports,
        },
        new()
        {
            Id = "97",
            ...
            ObjectsToTrigger = [],
            ApItemId = ApItemId.SwitchHopWormPillar,
            ApLocationId = ApLocationId.HopSwitchWormPillar,
        },
        new()
        {
            Id = "101",
            ...
            ObjectsToTrigger = [],
            ApItemId = ApItemId.CrystalHopAfterClaw,
            ApLocationId = ApLocationId.HopCrystalAfterClaw,
        },
        new()
        {
            Id = "102",
        ...
        new()
        {
            ...
            ObjectsToTrigger = [],
            ApItemId = ApItemId.FaceHopOldMan,
            ApLocationId = ApLocationId.HopFaceOldMan,
        },
        new()
        {
            Id = "117",
        ...
        new()
        {
            ...
            ObjectsToTrigger = [],
            ApItemId = ApItemId.SwitchHopToClaw1,
            ApLocationId = ApLocationId.HopSwitchToClaw1,
        },
        new()
        {
            Id = "162",
            ...
            ObjectsToDisable = [],
            ObjectsToTrigger = [],
            ApItemId = ApItemId.SwitchHopToClaw2,
            ApLocationId = ApLocationId.HopSwitchToClaw2,
        },
        new()
        {
            Id = "163",
        ...
        new()
        {
            ...
            ObjectsToTrigger = [],
            ApItemId = ApItemId.SwitchHopClawAccess,
            ApLocationId = ApLocationId.HopSwitchClawAccess,
        },
        new()
        {
            Id = "165",
            ...
            ObjectsToTrigger = [],
            ApItemId = ApItemId.SwitchHopGhosts,
            ApLocationId = ApLocationId.HopSwitchGhosts,
        },
        new()
        {
            Id = "171",
        ...
        new()
        {
            ...
            ObjectsToTrigger = [],
            ApItemId = ApItemId.SwitchHopLeft3,
            ApLocationId = ApLocationId.HopSwitchLeft3,
        },
        new()
        {
            Id = "178",
        ...
        new()
        {
            ...
            ObjectsToTrigger = [],
            ApItemId = ApItemId.SwitchHopAboveOldMan,
            ApLocationId = ApLocationId.HopSwitchAboveOldMan,
        },
        new()
        {
            Id = "182",
            ...
            ObjectsToDisable = [],
            ObjectsToTrigger = [],
            ApItemId = ApItemId.CrystalHopMaiden1,
            ApLocationId = ApLocationId.HopCrystalMaiden1,
        },
        new()
        {
            Id = "183",
            ...
            ObjectsToTrigger = [],
            ApItemId = ApItemId.CrystalHopMaiden2,
            ApLocationId = ApLocationId.HopCrystalMaiden2,
        },
        new()
        {
            Id = "184",
            ...
            ObjectsToDisable = [],
            ObjectsToTrigger = [],
            ApItemId = ApItemId.SwitchHopToAboveOldMan,
            ApLocationId = ApLocationId.HopSwitchToAboveOldMan,
        },
        new()
        {
            Id = "186",
            ...
            ObjectsToTrigger = [],
            ApItemId = ApItemId.SwitchHopTpPuzzle,
            ApLocationId = ApLocationId.HopSwitchTpPuzzle,
        },
        new()
        {
            Id = "190",
        ...
        new()
        {
            ...
            ObjectsToTrigger = [],
            ApItemId = ApItemId.SwitchHopEyeballShortcut,
            ApLocationId = ApLocationId.HopSwitchEyeballShortcut,
        },
        new()
        {
            Id = "196",
        ...
        new()
        {
            ...
            ObjectsToDisable = [],
            ObjectsToTrigger = [],
            ApItemId = ApItemId.CrystalHopBellAccess,
            ApLocationId = ApLocationId.HopCrystalBellAccess,
        },
        new()
        {
            Id = "199",
            ...
            ObjectsToDisable = [],
            ObjectsToTrigger = [],
            ApItemId = ApItemId.CrystalHopHeart,
            ApLocationId = ApLocationId.HopCrystalHeart,
        },
        new()
        {
            Id = "199",
            ...
            ObjectsToTrigger = [],
            ApItemId = ApItemId.SwitchHopBellAccess,
            ApLocationId = ApLocationId.HopSwitchBellAccess,
        },
        new()
        {
            Id = "200",
        ...
        new()
        {
            ...
            ObjectsToTrigger = [],
            ApItemId = ApItemId.SwitchHop1stRoom,
            ApLocationId = ApLocationId.HopSwitch1stRoom,
        },
        new()
        {
            Id = "257",
            ...
            ObjectsToTrigger = [],
            ApItemId = ApItemId.SwitchHopLeftBacktrack,
            ApLocationId = ApLocationId.HopSwitchLeftBacktrack,
        },
        new()
        {
            Id = "260",
        ...
        new()
        {
            ...
            ObjectsToTrigger = [],
            ApItemId = ApItemId.CrystalHopBelowPuzzle,
            ApLocationId = ApLocationId.HopCrystalBelowPuzzle,
        },
        new()
        {
            Id = "276",
    ...
    public static readonly Dictionary<int, ApLocationId> ElevatorToLocation = new()
    {
        ...
        { 10535, ApLocationId.HopElevator },
    ...
    public static readonly Dictionary<ApItemId, string> ItemNames = new()
    {
        ...
        { ApItemId.OrbMulti, "Orb Multiplier" },
        { ApItemId.WhiteDoorGtStart, "White Door GT 1st Room" },
        { ApItemId.WhiteDoorGtMap, "White Door GT Linus' Map" },
        { ApItemId.WhiteDoorGtTauros, "White Door GT Boss" },
        { ApItemId.WhiteDoorMech2nd, "White Door Mech 2nd Room" },
        { ApItemId.WhiteDoorMechBk, "White Door Mech Black Knight" },
        { ApItemId.WhiteDoorMechArena, "White Door Mech Enemy Arena" },
        { ApItemId.WhiteDoorMechTop, "White Door Mech Top" },
        { ApItemId.WhiteDoorHopStart, "White Door HoP 1st Room" },
        { ApItemId.WhiteDoorHopClaw, "White Door HoP Griffon Claw" },
        { ApItemId.WhiteDoorHopBoss, "White Door HoP Boss" },
        { ApItemId.WhiteDoorRoaWorms, "White Door RoA Worms" },
        { ApItemId.WhiteDoorRoaAscend, "White Door RoA Ascend" },
        { ApItemId.WhiteDoorRoaBalls, "White Door RoA Spike Balls" },
        { ApItemId.WhiteDoorRoaSpinners, "White Door RoA Spike Spinners" },
        { ApItemId.WhiteDoorRoaSkip, "White Door RoA Skippable" },
        { ApItemId.WhiteDoorCataTop, "White Door Cata Top" },
        { ApItemId.WhiteDoorCataBlue, "White Door Cata After Blue Door" },
        { ApItemId.WhiteDoorCataPrison, "White Door Cata Prison" },
        { ApItemId.BlueDoorGtHunter, "Blue Door GT Bestiary" },
        { ApItemId.BlueDoorGtRing, "Blue Door GT Ring of the Ancients" },
        { ApItemId.BlueDoorGtOrbs, "Blue Door GT Bonus Orbs" },
        { ApItemId.BlueDoorGtAscendant, "Blue Door GT Ascendant Key" },
        { ApItemId.BlueDoorGtSword, "Blue Door GT Sword of Mirrors" },
        { ApItemId.BlueDoorMechRed, "Blue Door Mech Red Key" },
        { ApItemId.BlueDoorMechShortcut, "Blue Door Mech Shortcut" },
        { ApItemId.BlueDoorMechMusic, "Blue Door Mech Music Test" },
        { ApItemId.BlueDoorMechBoots, "Blue Door Mech Talaria Boots" },
        { ApItemId.BlueDoorMechVoid, "Blue Door Mech Void Charm" },
        { ApItemId.BlueDoorMechCd, "Blue Door Mech Cyclops Den" },
        { ApItemId.BlueDoorHopStart, "Blue Door HoP Above Start" },
        { ApItemId.BlueDoorHopStatue, "Blue Door HoP Epimetheus" },
        { ApItemId.BlueDoorHopMaiden, "Blue Door HoP Dead Maiden" },
        { ApItemId.BlueDoorRoaFlames, "Blue Door RoA Flames" },
        { ApItemId.BlueDoorRoaBlood, "Blue Door RoA Blood Pot" },
        { ApItemId.BlueDoorApex, "Blue Door Apex" },
        { ApItemId.BlueDoorCaves, "Blue Door Caves" },
        { ApItemId.BlueDoorCataOrbs, "Blue Door Cata Bonus Orbs" },
        { ApItemId.BlueDoorCataSave, "Blue Door Cata Checkpoint" },
        { ApItemId.BlueDoorCataBow, "Blue Door Cata Lunarian Bow" },
        { ApItemId.BlueDoorCataRoots, "Blue Door Cata Poison Roots" },
        ...
        { ApItemId.ShopUpgradeAlgusArcanist, "Arcanist" },
        { ApItemId.ShopUpgradeAlgusShock, "Shock Field" },
        { ApItemId.ShopUpgradeAlgusMeteor, "Meteor Rain" },
        { ApItemId.ShopUpgradeAriasGorgonslayer, "Gorgonslayer" },
        { ApItemId.ShopUpgradeAriasLastStand, "Last Stand" },
        { ApItemId.ShopUpgradeAriasLionheart, "Lionheart" },
        { ApItemId.ShopUpgradeKyuliAssassin, "Assassin Strike" },
        { ApItemId.ShopUpgradeKyuliBullseye, "Bullseye" },
        { ApItemId.ShopUpgradeKyuliRay, "Shining Ray" },
        { ApItemId.ShopUpgradeZeekJunkyard, "Junkyard Hunt" },
        { ApItemId.ShopUpgradeZeekOrbs, "Orb Monger" },
        { ApItemId.ShopUpgradeZeekLoot, "Bigger Loot" },
        { ApItemId.ShopUpgradeBramAxe, "Golden Axe" },
        { ApItemId.ShopUpgradeBramHunter, "Monster Hunter" },
        { ApItemId.ShopUpgradeBramWhiplash, "Whiplash" },
        { ApItemId.ElevatorGt1, "GT 1 Elevator" },
        { ApItemId.ElevatorGt2, "GT 2 Elevator" },
        { ApItemId.ElevatorMech1, "Mech 1 Elevator" },
        { ApItemId.ElevatorMech2, "Mech 2 Elevator" },
        { ApItemId.ElevatorHop, "HoP Elevator" },
        { ApItemId.ElevatorRoa1, "RoA 1 Elevator" },
        { ApItemId.ElevatorRoa2, "RoA 2 Elevator" },
        { ApItemId.ElevatorApex, "Apex Elevator" },
        { ApItemId.ElevatorCata1, "Cata 1 Elevator" },
        { ApItemId.ElevatorCata2, "Cata 2 Elevator" },
        { ApItemId.ElevatorTr, "TR Elevator" },
        { ApItemId.SwitchGt2ndRoom, "Door GT 2nd Room" },
        { ApItemId.SwitchGt1stCyclops, "Door GT 1st Cyclops" },
        { ApItemId.SwitchGtSpikeTunnel, "Door GT Spike Tunnel" },
        { ApItemId.SwitchGtButtAccess, "Door GT Butt Access" },
        { ApItemId.SwitchGtGh, "Blocks GT Gorgonheart" },
        { ApItemId.SwitchGtUpperPathBlocks, "Blocks GT Upper Path" },
        { ApItemId.SwitchGtUpperPathAccess, "Door GT Upper Path" },
        { ApItemId.SwitchGtCrosses, "Door GT Crosses" },
        { ApItemId.SwitchGtGhShortcut, "Blocks GT Gorgonheart Shortcut" },
        { ApItemId.SwitchGtArias, "Blocks GT Arias Path" },
        { ApItemId.SwitchGtSwordAccess, "Door GT Sword Access" },
        { ApItemId.SwitchGtSwordBacktrack, "Blocks GT Sword Backtrack" },
        { ApItemId.SwitchGtSword, "Blocks GT Sword" },
        { ApItemId.SwitchGtUpperArias, "Door GT Upper Arias" },
        { ApItemId.SwitchMechWatcher, "Door Mech Watcher" },
        { ApItemId.SwitchMechChains, "Door Mech Chains" },
        { ApItemId.SwitchMechBoss1, "Door Mech Boss Lower" },
        { ApItemId.SwitchMechBoss2, "Door Mech Boss Upper" },
        { ApItemId.SwitchMechSplitPath, "Door Mech Split Path" },
        { ApItemId.SwitchMechSnake1, "Door Mech Snake Upper" },
        { ApItemId.SwitchMechBoots, "Door Mech Boots" },
        { ApItemId.SwitchMechToUpperGt, "Door Mech to Upper GT" },
        { ApItemId.SwitchMechUpperVoidDrop, "Blocks Mech Upper Void Drop" },
        { ApItemId.SwitchMechUpperVoid, "Door Mech Upper Void" },
        { ApItemId.SwitchMechLinus, "Door Mech Linus Lower" },
        { ApItemId.SwitchMechToBoss2, "Door Mech To Boss" },
        { ApItemId.SwitchMechPots, "Door Mech Pots" },
        { ApItemId.SwitchMechMazeBackdoor, "Blocks Mech Maze Backdoor" },
        { ApItemId.SwitchMechToBoss1, "Blocks Mech To Boss Switches" },
        { ApItemId.SwitchMechBlockStairs, "Blocks Mech Staircase Up" },
        { ApItemId.SwitchMechAriasCyclops, "Blocks Mech Arias Cyclops" },
        { ApItemId.SwitchMechBootsLower, "Blocks Mech Boots Lower" },
        { ApItemId.SwitchMechChainsGap, "Blocks Mech Chains Gap" },
        { ApItemId.SwitchMechLowerKey, "Door Mech Lower Key" },
        { ApItemId.SwitchMechArias, "Door Mech Arias" },
        { ApItemId.SwitchMechSnake2, "Door Mech Snake Lower" },
        { ApItemId.SwitchMechKeyBlocks, "Blocks Mech Key Cage" },
        { ApItemId.SwitchMechCannon, "Door Mech Cannon Upper" },
        { ApItemId.SwitchMechEyeball, "Door Mech Eyeball" },
        { ApItemId.SwitchMechInvisible, "Door Mech Invisible" },
        { ApItemId.SwitchMechSkullPuzzle, "Door Mech Skull Puzzle" },
        { ApItemId.SwitchHopRock, "Rockfall HoP" },
        { ApItemId.SwitchHopBelowStart, "Door HoP Below Start" },
        { ApItemId.SwitchHopLeft2, "Door HoP Left 2" },
        { ApItemId.SwitchHopLeft1, "Door HoP Left 1" },
        { ApItemId.SwitchHopLowerShortcut, "Door HoP Lower Shortcut" },
        { ApItemId.SwitchHopBell, "Blocks HoP Bell" },
        { ApItemId.SwitchHopGhostBlood, "Door HoP Ghost Blood" },
        { ApItemId.SwitchHopTeleports, "Door HoP Teleports" },
        { ApItemId.SwitchHopWormPillar, "Door HoP Worm Pillar" },
        { ApItemId.SwitchHopToClaw1, "Door HoP To Claw" },
        { ApItemId.SwitchHopToClaw2, "Blocks HoP To Claw" },
        { ApItemId.SwitchHopClawAccess, "Blocks HoP Claw Access" },
        { ApItemId.SwitchHopGhosts, "Door HoP Ghosts" },
        { ApItemId.SwitchHopLeft3, "Blocks HoP Left" },
        { ApItemId.SwitchHopAboveOldMan, "Door HoP Above Old Man" },
        { ApItemId.SwitchHopToAboveOldMan, "Blocks HoP To Above Old Man" },
        { ApItemId.SwitchHopTpPuzzle, "Door HoP TP Puzzle" },
        { ApItemId.SwitchHopEyeballShortcut, "Blocks HoP Eyeball Shortcut" },
        { ApItemId.SwitchHopBellAccess, "Blocks HoP Bell Access Left" },
        { ApItemId.SwitchHop1stRoom, "Blocks HoP 1st Room" },
        { ApItemId.SwitchHopLeftBacktrack, "Blocks HoP Left Backtrack" },
        { ApItemId.SwitchHopSkullPuzzle, "Door HoP Skull Puzzle" },
        { ApItemId.SwitchRoaAscend, "Blocks RoA Ascend" },
        { ApItemId.SwitchRoaAfterWorms, "Blocks RoA After Worms" },
        { ApItemId.SwitchRoaRightPath, "Blocks RoA Right Path" },
        { ApItemId.SwitchRoaApexAccess, "Blocks RoA Apex Access" },
        { ApItemId.SwitchRoaIcarus, "Blocks RoA Icarus" },
        { ApItemId.SwitchRoaShaftL, "Blocks RoA Shaft Left" },
        { ApItemId.SwitchRoaShaftR, "Blocks RoA Shaft Right" },
        { ApItemId.SwitchRoaElevator, "Blocks RoA Elevator" },
        { ApItemId.SwitchRoaShaftDownwards, "Blocks RoA Shaft Downwards" },
        { ApItemId.SwitchRoaSpiders, "Blocks RoA Spiders Upper" },
        { ApItemId.SwitchRoaDarkRoom, "Blocks RoA Dark Room" },
        { ApItemId.SwitchRoaAscendShortcut, "Blocks RoA Ascend Shortcut" },
        { ApItemId.SwitchRoa1stShortcut, "Blocks RoA 1st Shortcut" },
        { ApItemId.SwitchRoaSpikeClimb, "Door RoA Spike Climb" },
        { ApItemId.SwitchRoaAboveCentaur, "Blocks RoA Above Centaur" },
        { ApItemId.SwitchRoaBloodPot, "Blocks RoA Blood Pot" },
        { ApItemId.SwitchRoaWorms, "Door RoA Worms" },
        { ApItemId.SwitchRoaTriple1, "Blocks RoA Triple Left" },
        { ApItemId.SwitchRoaTriple3, "Door RoA Triple Right" },
        { ApItemId.SwitchRoaBabyGorgon, "Blocks RoA Baby Gorgon" },
        { ApItemId.SwitchRoaBossAccess, "Blocks RoA Boss Access" },
        { ApItemId.SwitchRoaBloodPotL, "Door RoA Blood Pot Left" },
        { ApItemId.SwitchRoaBloodPotR, "Door RoA Blood Pot Right" },
        { ApItemId.SwitchRoaLowerVoid, "Door RoA Lower Void" },
        { ApItemId.SwitchDarkness, "Door Dark" },
        { ApItemId.SwitchApex, "Blocks Apex" },
        { ApItemId.SwitchCavesSkeletons, "Door Caves Skeletons" },
        { ApItemId.SwitchCavesCata1, "Door Caves Cata Access 1" },
        { ApItemId.SwitchCavesCata2, "Door Caves Cata Access 2" },
        { ApItemId.SwitchCavesCata3, "Door Caves Cata Access 3" },
        { ApItemId.SwitchCataElevator, "Door Cata Elevator" },
        { ApItemId.SwitchCataVerticalShortcut, "Door Cata Vertical Shortcut" },
        { ApItemId.SwitchCataTop, "Blocks Cata Top" },
        { ApItemId.SwitchCataClaw1, "Door Cata Claw Right" },
        { ApItemId.SwitchCataClaw2, "Door Cata Claw Left" },
        { ApItemId.SwitchCataWater1, "Door Cata Water 1" },
        { ApItemId.SwitchCataWater2, "Door Cata Water 2" },
        { ApItemId.SwitchCataDevRoom, "Blocks Cata Dev Room" },
        { ApItemId.SwitchCataAfterBlueDoor, "Blocks Cata After Blue Door" },
        { ApItemId.SwitchCataShortcutAccess, "Door Cata Shortcut Access" },
        { ApItemId.SwitchCataLadderBlocks, "Blocks Cata Ladder" },
        { ApItemId.SwitchCataMidShortcut, "Blocks Cata Mid Shortcut" },
        { ApItemId.SwitchCata1stRoom, "Door Cata 1st Room" },
        { ApItemId.SwitchCataFlames2, "Blocks Cata Flames Left" },
        { ApItemId.SwitchCataFlames1, "Blocks Cata Flames Right" },
        { ApItemId.SwitchTrAdornedL, "Door TR Adorned Left" },
        { ApItemId.SwitchTrAdornedM, "Door TR Adorned Middle" },
        { ApItemId.SwitchTrAdornedR, "Door TR Adorned Right" },
        { ApItemId.SwitchTrElevator, "Door TR Elevator" },
        { ApItemId.SwitchTrBottom, "Blocks TR Bottom" },
        { ApItemId.SwitchCd1, "Door CD 1" },
        { ApItemId.SwitchCd2, "Blocks CD Backtrack 2" },
        { ApItemId.SwitchCd3, "Blocks CD 3" },
        { ApItemId.SwitchCdCampfire, "Blocks CD Campfire" },
        { ApItemId.SwitchCdTop, "Blocks CD Top" },
        { ApItemId.SwitchCathBottom, "Blocks Cath Bottom" },
        { ApItemId.SwitchCathBesideShaft, "Blocks Cath Beside Shaft" },
        { ApItemId.SwitchCathTopCampfire, "Door Cath Top Campfire" },
        { ApItemId.SwitchSpDoubleDoors, "Door SP Double" },
        { ApItemId.SwitchSpBubbles, "Door SP Bubbles" },
        { ApItemId.SwitchSpAfterStar, "Door SP After Star" },
        { ApItemId.CrystalGtLadder, "Door GT Ladder" },
        { ApItemId.CrystalGtRota, "Door GT RotA" },
        { ApItemId.CrystalGtOldMan1, "Blocks GT Old Man 1" },
        { ApItemId.CrystalGtOldMan2, "Blocks GT Old Man 2" },
        { ApItemId.CrystalMechCannon, "Door Mech Cannon Lower" },
        { ApItemId.CrystalMechLinus, "Door Mech Linus Upper" },
        { ApItemId.CrystalMechLower, "Blocks Mech Lower" },
        { ApItemId.CrystalMechToBoss3, "Blocks Mech Staircase To Boss" },
        { ApItemId.CrystalMechTriple1, "Door Mech Triple 1" },
        { ApItemId.CrystalMechTriple2, "Door Mech Triple 2" },
        { ApItemId.CrystalMechTriple3, "Door Mech Triple 3" },
        { ApItemId.CrystalMechTop, "Blocks Mech Top" },
        { ApItemId.CrystalMechCloak, "Door Mech Cloak" },
        { ApItemId.CrystalMechSlimes, "Blocks Mech Slimes" },
        { ApItemId.CrystalMechToCd, "Blocks Mech To CD" },
        { ApItemId.CrystalMechCampfire, "Blocks Mech Campfire" },
        { ApItemId.CrystalMech1stRoom, "Blocks Mech 1st Room" },
        { ApItemId.CrystalMechOldMan, "Blocks Mech Old Man" },
        { ApItemId.CrystalMechTopChains, "Blocks Mech Top Chains" },
        { ApItemId.CrystalMechBk, "Blocks Mech BK" },
        { ApItemId.CrystalHopRockAccess, "Door HoP Rock" },
        { ApItemId.CrystalHopBottom, "Door HoP Bottom" },
        { ApItemId.CrystalHopLower, "Blocks HoP Lower" },
        { ApItemId.CrystalHopAfterClaw, "Door HoP After Claw" },
        { ApItemId.CrystalHopMaiden1, "Blocks HoP Maiden" },
        { ApItemId.CrystalHopMaiden2, "Door HoP Maiden" },
        { ApItemId.CrystalHopBellAccess, "Blocks HoP Bell Access Right" },
        { ApItemId.CrystalHopHeart, "Blocks HoP Heart" },
        { ApItemId.CrystalHopBelowPuzzle, "Blocks HoP Below Puzzle" },
        { ApItemId.CrystalRoa1stRoom, "Door RoA 1st Room" },
        { ApItemId.CrystalRoaBabyGorgon, "Door RoA Baby Gorgon" },
        { ApItemId.CrystalRoaLadderR, "Blocks RoA Ladder Right" },
        { ApItemId.CrystalRoaLadderL, "Blocks RoA Ladder Left" },
        { ApItemId.CrystalRoaCentaur, "Blocks RoA Centaur" },
        { ApItemId.CrystalRoaSpikeBalls, "Blocks RoA Spike Balls" },
        { ApItemId.CrystalRoaLeftAscend, "Blocks RoA Left Ascend" },
        { ApItemId.CrystalRoaShaft, "Blocks RoA Shaft" },
        { ApItemId.CrystalRoaBranchR, "Blocks RoA Branch Right" },
        { ApItemId.CrystalRoaBranchL, "Blocks RoA Branch Left" },
        { ApItemId.CrystalRoa3Reapers, "Door RoA 3 Reapers" },
        { ApItemId.CrystalRoaTriple2, "Door RoA Triple Top" },
        { ApItemId.CrystalCataPoisonRoots, "Blocks Cata Poison Roots" },
        { ApItemId.CrystalTrGold, "Blocks TR Gold" },
        { ApItemId.CrystalTrDarkArias, "Blocks TR Dark Arias" },
        { ApItemId.CrystalCdBacktrack, "Blocks CD Backtrack" },
        { ApItemId.CrystalCdStart, "Door CD Start" },
        { ApItemId.CrystalCdCampfire, "Door CD Campfire" },
        { ApItemId.CrystalCdSteps, "Door CD Steps" },
        { ApItemId.CrystalCath1stRoom, "Door Cath 1st Room" },
        { ApItemId.CrystalCathShaft, "Door Cath Shaft" },
        { ApItemId.CrystalCathSpikePit, "Door Cath Spike Pit" },
        { ApItemId.CrystalCathTopL, "Blocks Cath Top Left" },
        { ApItemId.CrystalCathTopR, "Blocks Cath Top Right" },
        { ApItemId.CrystalCathShaftAccess, "Door Cath Shaft Access" },
        { ApItemId.CrystalCathOrbs, "Door Cath Orbs" },
        { ApItemId.CrystalSpBlocks, "Blocks SP Shaft" },
        { ApItemId.CrystalSpStar, "Blocks SP Star" },
        { ApItemId.FaceMechVolantis, "Blocks Mech Above Volantis" },
        { ApItemId.FaceHopOldMan, "Blocks HoP Old Man" },
        { ApItemId.FaceRoaSpiders, "Blocks RoA Spiders Lower" },
        { ApItemId.FaceRoaBlueKey, "Blocks RoA Blue Key" },
        { ApItemId.FaceCaves1stRoom, "Blocks Caves 1st Room" },
        { ApItemId.FaceCataAfterBow, "Blocks Cata After Bow" },
        { ApItemId.FaceCataBow, "Blocks Cata Bow" },
        { ApItemId.FaceCataX4, "Door Cata x4 Faces" },
        { ApItemId.FaceCataCampfire, "Blocks Cata Campfire" },
        { ApItemId.FaceCataDoubleDoor, "Door Cata Double" },
        { ApItemId.FaceCataBottom, "Blocks Cata Bottom" },
        { ApItemId.FaceCathL, "Blocks Cath Left" },
        { ApItemId.FaceCathR, "Blocks Cath Right" },
        { ApItemId.Heal5, "Heal HP +5" },
        { ApItemId.TrapCutscene, "Cutscene Trap" },
        { ApItemId.TrapRocks, "Rocks Trap" },
    };
    ...
    [
        ...
        new()
        {
            Id = 5032,
            RoomId = 820,
            ApLocationId = ApLocationId.HopCandle1stRoom,
        },
        new()
        {
            Id = 5033,
            RoomId = 2676,
            ApLocationId = ApLocationId.HopCandleLower,
        },
        new()
        {
            Id = 5035,
            RoomId = 2681,
            ApLocationId = ApLocationId.HopCandleBell,
        },
        new()
        {
            Id = 5036,
            RoomId = 2902,
            ApLocationId = ApLocationId.HopCandleEyeball,
        },
        new()
        {
            Id = 5037,
            RoomId = 3617,
            ApLocationId = ApLocationId.HopCandleOldMan,
        },
        new()
        {
            Id = 5038,
            RoomId = 2897,
            ApLocationId = ApLocationId.HopCandleBeforeClaw,
        },
        new()
        {
            Id = 5039,
            RoomId = 2901,
            ApLocationId = ApLocationId.HopCandleClawCampfire,
        },
        new()
        {
            Id = 5040,
            RoomId = 2890,
            ApLocationId = ApLocationId.HopCandleTpPuzzle,
        },
        new()
        {
            Id = 5041,
            RoomId = 3259,
            ApLocationId = ApLocationId.HopCandleTpFall,
        },
        new()
        {
            Id = 5042,
        ...
        new()
        {
            Id = 5043,
            RoomId = 2889,
            ApLocationId = ApLocationId.HopCandleBoss,
        },
        new()
        {
            Id = 6665,
        ...
        new()
        {
            Id = 6674,
            RoomId = 3265,
            ApLocationId = ApLocationId.HopCandleUpperVoid1,
        },
        new()
        {
            Id = 6675,
            RoomId = 3265,
            ApLocationId = ApLocationId.HopCandleUpperVoid2,
        },
        new()
        {
            Id = 6676,
            RoomId = 3265,
            ApLocationId = ApLocationId.HopCandleUpperVoid3,
        },
        new()
        {
            Id = 6677,
            RoomId = 3265,
            ApLocationId = ApLocationId.HopCandleUpperVoid4,
        },
        new()
        {
            Id = 6678,
        ...
        new()
        {
            Id = 10545,
            RoomId = 2894,
            ApLocationId = ApLocationId.HopCandleElevator,
        },
        new()
        {
            Id = 10740,
    ...
    {
        { (1099, 1057), "GT Entrance Portal" },
        { (186, 1056), "GT Void Portal" },
        { (877, 1058), "Mech Lower Void Portal" },
        { (1315, 1317), "Mech Upper Void Portal" },
        { (879, 1059), "HoP Lower Void Portal" },
        { (3264, 3194), "HoP Upper Void Portal" },
        { (7056, 7249), "HoP Cathedral Void Portal" },
        { (7272, 7274), "Cath Start Portal" },
        { (7437, 10748), "RoA Lower Void Portal" },
        { (4094, 10749), "RoA Upper Void Portal" },
        { (3795, 4344), "Cata Void Right Portal" },
        { (4336, 4343), "Cata Void Left Portal" },
    };
